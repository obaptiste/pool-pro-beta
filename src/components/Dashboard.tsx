...
import { Reading, MaintenanceTask, DEFAULT_RANGES, Status } from '../types';
...
export default function Dashboard({ readings, tasks, onLogReading, onOpenCheatSheet, onOpenGlossary, onViewHistory, onExport, onPrint, toggleTask }: Props) {
